class Food < ActiveRecord::Base
  # don't name attributes in all caps. All caps are constants ruby and will give a lot of trouble.
  ...
  # this doesn't belong here, it should be on your basket model.
